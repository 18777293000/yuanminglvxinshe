...
Page({
    ...
    onShareAppMessage: function(t) {
        var e = t.target.dataset.index, o = "/pages/pt/group/details?oid=" + t.target.dataset.id;
        return {
    ...
    countDown: function() {
        ...
        setInterval(function() {
            var t = n.data.order_list;
            for (var e in t) {
                var o = new Date(t[e].limit_time_ms[0], t[e].limit_time_ms[1] - 1, t[e].limit_time_ms[2], t[e].limit_time_ms[3], t[e].limit_time_ms[4], t[e].limit_time_ms[5]) - new Date(), a = parseInt(o / 1e3 / 60 / 60 / 24, 10), i = parseInt(o / 1e3 / 60 / 60 % 24, 10), s = parseInt(o / 1e3 / 60 % 60, 10), r = parseInt(o / 1e3 % 60, 10);
                a = n.checkTime(a), i = n.checkTime(i), s = n.checkTime(s), r = n.checkTime(r), 
                t[e].limit_time = {
                    days: a,
                    hours: 0 < i ? i : "00",
                    mins: 0 < s ? s : "00",
