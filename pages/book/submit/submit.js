...
Page({
    ...
    checkboxChange: function(t) {
        var e = t.target.dataset.pid, a = t.target.dataset.id, o = this.data.form_list, s = o[e].default[a].selected;
        o[e].default[a].selected = 1 != s, this.setData({
            form_list: o
        });
    },
    ...
    submit: function(t) {
        var e = t.detail.formId, a = this.data.goods.id, o = JSON.stringify(this.data.attr), s = JSON.stringify(this.data.form_list), i = this.data.pay_type;
        getApp().core.showLoading({
            title: "正在提交",
            mask: !0
        }), getApp().request({
