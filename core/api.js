...
var api = {
    ...
    default: {
        ...
        kefu: _api_root + "default/contact"
    },
    cart: {
    ...
    order: {
        ...
        oylist: siteroot + "addons/zjhj_mall/core/web/index.php?_acid=" + siteinfo.acid + "&cat_id=12" + "&r=api/" + "order/list",
        czlist: siteroot + "addons/zjhj_mall/core/web/index.php?_acid=" + siteinfo.acid + "&cat_id=13" + "&r=api/" + "order/list",
